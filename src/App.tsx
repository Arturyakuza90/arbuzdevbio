...
const HACK_LINES = [
  "> root@arbuzdev:~# ./breach --target=localhost",
  ...
  return (
    <div className="glass-card fade-in-card w-[min(92vw,760px)] px-6 sm:px-9 py-6 sm:py-7">
      ...
      <div className="mt-5 flex items-center justify-center gap-3 sm:gap-4 flex-wrap">
        <button
          type="button"
          onClick={() => navigator.clipboard?.writeText("catzhenya4").catch(() => {})}
          ...
          title="Discord: @catzhenya4 (click to copy)"
        >
          <DiscordIcon />
          <span className="pt-[2px]">@catzhenya4</span>
        </button>
        ...
        >
          ...
          <span className="pt-[2px]">Donate</span>
        </a>
      </div>
    </div>
  );
